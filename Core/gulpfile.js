    ...
    css:
        {
            ...
            plugins:
                [
                    ...
                    path.join(__dirname, "bower_components/magnific-popup/dist/magnific-popup.css"),
                    // path.join(__dirname, "bower_components/wow/css/libs/animate.css"),
                    path.join(__dirname, "bower_components/animate.css/animate.css"),
                    // path.join(__dirname, "bower_components/fancybox/dist/jquery.fancybox.css"),
    ...
    js:
        {
            ...
            plugins:
                [
                    ...
                    path.join(__dirname, "bower_components/jquery.easing/js/jquery.easing.min.js"),
                    path.join(__dirname, "bower_components/jquery.stellar/jquery.stellar.min.js"),
                    path.join(__dirname, "bower_components/magnific-popup/dist/jquery.magnific-popup.min.js"),
                    path.join(__dirname, "bower_components/isotope-layout/dist/isotope.pkgd.js"),
                    path.join(__dirname, "bower_components/wow/dist/wow.js"),
                    // path.join(__dirname, "bower_components/fancybox/dist/jquery.fancybox.js"),
                    path.join(__dirname, "bower_components/masonry-layout/masonry.js"),
...
gulp.task('clean-sass', function (file) {
  return gulp.src([
        path.join(__dirname, targetPath + '/css/main.css'), 
        path.join(__dirname, targetPath + '/css/maps/main.css.map'), 
        ], {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-pages', function () {
  return gulp.src([
        path.join(__dirname, targetPath + '/css/*pages*/*.css'),
        path.join(__dirname, targetPath + '/css/maps/*pages*/*.css.map')
        ], {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-sass-vendor', function () {
  return gulp.src([
        path.join(__dirname, targetPath + '/css/vendor.min.css'),
        path.join(__dirname, targetPath + '/css/maps/vendor.min.css.map')
        ], {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-sass-plugins', function () {
  return gulp.src([
        path.join(__dirname, targetPath + '/css/plugins.min.css'),
        path.join(__dirname, targetPath + '/css/maps/plugins.min.css.map')
        ], {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-js', function () {
  return gulp.src(path.join(__dirname, targetPath + '/js/app.min.js'), {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-js_vendor', function () {
  return gulp.src(path.join(__dirname, targetPath + '/js/vendor.min.js'), {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-js_plugins', function () {
  return gulp.src(path.join(__dirname, targetPath + '/js/plugins.min.js'), {read: false})
    .pipe(clean({force: true}));
});
gulp.task('clean-js_custom', function () {
  return gulp.src(path.join(__dirname, targetPath + '/js/*Includes*/*.js'), {read: false})
    .pipe(clean({force: true}));
});
// CLEANER
...
gulp.task('sass', ['clean-sass'], function() {
    return gulp.src(paths.sass)
        ...
        //.pipe(uglifycss())
        .pipe(sourcemaps.write(path.join(__dirname, targetPath + '/css/maps'), {
            includeContent: false, 
            sourceRoot: path.join(__dirname, targetPath + '/css/maps'),
